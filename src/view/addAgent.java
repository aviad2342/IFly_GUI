...
public class addAgent extends javax.swing.JInternalFrame {
    //***************************************** Variables *********************************************
    /**view field*/
     ...
     * @param myDesk
     */
    public addAgent(ViewLogic view, MyDesktopPane myDesk) {
        this.view = view;
        this.myDesk = myDesk;
        setTitle("Add Agent"); //the title of the frame
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setFrameIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Online Agent Add.jpg"))); // NOI18N
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        view.addAgent(txtEmployeeNumber, txtFirstName, txtLastName, birthDate, startWorkingDate, txtPassWord, txtCountry, cbCity, txtStreet, txtHouseNumber, txtPhoneNumber1, txtPhoneNum2, this);
        }
